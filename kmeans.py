...
if __name__ == "__main__":
    ...
    print('using 2 parameters: $./kmeans.py percentageOfTraining  dimensionsToRescalePCA')
    print('If none parameters used, using 80 100')
    #BD = load_object("BD")
    ...
    kmeans = KMeans(n_clusters=2, random_state=0).fit(Xtr)
    ...
    pred = postprocessing(pred, Names,Xt, len(Xtr))
...
--------------------------------------
    ...
    print(confusion_matrix(XLabtr, pred))
    print(classification_report(XLabtr, pred))
